      ...
      <div className="container-narrow relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <AnimateOnScroll delay={0.1}>
            ...
            >
              Three Steps.{" "}
              <span className="text-gradient-teal">Direct Settlement.</span> No
              Middle.
            </h2>
          </AnimateOnScroll>
        </div>
          ...
          {steps.map((step, i) => (
            <AnimateOnScroll key={step.number} delay={i * 0.1}>
              <div className="card group relative overflow-hidden h-full">
                ...
                <span
                  className="absolute top-4 right-6 text-7xl font-black text-white/[0.03] select-none pointer-events-none"
                  aria-hidden="true"
                >
                  {step.number}
                </span>
        ...
        <AnimateOnScroll delay={0.3}>
          <div
            className="card bg-deep-sea/80 overflow-x-auto"
            ...
            <div className="flex items-center justify-center gap-0 min-w-[520px] py-4">
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="w-20 h-16 rounded-xl bg-teal-bright/5 border border-teal-bright/40 flex flex-col items-center justify-center gap-1 px-2">
                  <span className="text-[10px] text-teal-bright font-mono text-center leading-tight">
                    WPGP Smart Contract
                  </span>
                  <span className="text-[9px] text-pewter font-mono">
                    Verifies
                  </span>
                </div>
                <span className="text-xs text-silver-mist font-medium">
